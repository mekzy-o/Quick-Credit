...
const { userSignup, userLogin, adminVerifyUser, resetPassword, getAllUsers, getSingleUser } = UserController;
const { loanApply, getLoans, getOneLoan, adminLoanDecision } = LoanController;
...
router.get("/api/v1/users/:email", verifyAdmin, getSingleUser);
